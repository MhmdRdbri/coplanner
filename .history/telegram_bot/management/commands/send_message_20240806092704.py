...
from your_app.models import CustomUser  # Replace with your actual user model
...
class Command(BaseCommand):
    ...
    async def send_message(self, bot, chat_id, message):
        try:
            await bot.send_message(chat_id=chat_id, text=message, timeout=10)  # Increase timeout to 10 seconds
        except Exception as e:
