...
class PendingRegistration(models.Model):
    ...
    def __str__(self):
        ...
        conn = http.client.HTTPSConnection("api2.ippanel.com")
                payload = json.dumps({"code": "vdphprz0qk3wgm7","sender": "+983000505","recipient": self.phone_number,"variable":{"full_name": f"{self.first_name}",}})headers = {'apikey': ' SZtX_MYwI2E0jWqdkrSoDV3-02u0yF-l2c1LXgZVZpw= ','Content-Type': 'application/json'}
