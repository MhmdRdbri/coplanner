...
class TimesheetSerializer(serializers.ModelSerializer):
    ...
    start_time = serializers.DateField(format="%Y-%m-%d %H:%M:%S", read_only=True)
    end_time = serializers.DateField(format="%Y-%m-%d %H:%M:%S", read_only=True)
