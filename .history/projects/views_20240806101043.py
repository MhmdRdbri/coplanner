...
class ProjectViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        logging.debug("Starting project creation")
        
        if not request.user.is_staff:
            logging.warning("Unauthorized project creation attempt by non-staff user")
        ...
        if serializer.is_valid():
            ...
            try:
                chat_id = request.user.telegram_chat_id  # Ensure this field is correctly set in your CustomUser model
                bot_token = settings.TELEGRAM_BOT_TOKEN  # Store your bot token in Django settings
        ...
        logging.error("Project creation failed due to invalid data")
