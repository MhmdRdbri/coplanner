        ...
        if self.responsible_person :
            ...
            try:
                ...
                payload = json.dumps({
                    ...
                    "variable": {
                        "full_name": f"{self.responsible_person.first_name}",
                    }
                })
                headers = {
            ...
            SMSLog.objects.create(
                project=self,
                full_name=self.responsible_person.last_name,
                result=result,
                status=status
            )
...
class ContentProject(models.Model):
    ...
    team_members = models.ManyToManyField(CustomUser, related_name='content_projects', blank=True)
